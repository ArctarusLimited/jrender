...
func init() {
	rootCmd.PersistentFlags().StringVarP(&options.outputFile, "output-file", "o", "", "File to be written to")
	rootCmd.PersistentFlags().StringArrayVarP(&options.jPathDirs, "jpath", "J", []string{}, "Specify an additional library search dir (right-most wins)")
